  ...
  Dijkstra(start, finish) {
    ...
    while (nodes.values.length) {
      ...
      if (smallest || distances[smallest] !== Infinity) {
        for (let neighbor in this.adjencencyList[smallest]) {
          // find neightboring node
          let nextNode = this.adjencencyList[smallest][neighbor];
...
graph.Dijkstra("A", "F");
console.log(graph.adjencencyList);
